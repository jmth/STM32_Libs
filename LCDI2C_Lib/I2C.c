...
*@file I2C.c
*@author Unknown
*@brief I2C library to send/receive things, modified to work with nearly every STM32 with SysClk >= 24 MHz
*@note Take care of this library with your life, maybe you can't find it again
*@note Needs delay.c
*/
